...
class PHPMailer
{
     ...
     * @link httpss://tools.ietf.org/html/rfc5321#section-4.4 RFC5321 reference
     */
    public $ReturnPath = '';
    ...
    public function createHeader()
    {
        ...
        if ($this->XMailer == '') {
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer ' . $this->Version . ' (httpss://github.com/PHPMailer/PHPMailer/)'
            );
        } else {
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                //Workaround for PHP bug httpss://bugs.php.net/bug.php?id=69197
    ...
    public static function _mime_types($ext = '')
    {
        $mimes = array(
            ...
            'php3'  => 'application/x-httpsd-php',
            'php4'  => 'application/x-httpsd-php',
            'php'   => 'application/x-httpsd-php',
            'phtml' => 'application/x-httpsd-php',
            'phps'  => 'application/x-httpsd-php-source',
